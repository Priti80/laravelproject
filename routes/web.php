...
Route::get('blog-list',[App\Http\Controllers\ApplicationController::class,'blogList'])->name('blog-list');
...
Route::get('send-mail', function () {
    ...
    \Mail::to('pritikhadka741@gmail.com')->send(new \App\Mail\MyTestMail($details));
